 ...
 */
package com.newrelic.telemetry.client;

import com.newrelic.telemetry.core.BaseConfig;
import com.newrelic.telemetry.core.Telemetry;
...
import com.newrelic.telemetry.core.exceptions.RetryWithRequestedWaitException;
import com.newrelic.telemetry.core.exceptions.RetryWithSplitException;
...
public class TelemetryClient {
  ...
  /**
   * Send a batch of {@link com.newrelic.telemetry.core.metrics.Metric} instances, with standard
   * retry logic. This happens on a background thread, asynchronously, so currently there will be no
  ...
  /**
   * Send a batch of {@link com.newrelic.telemetry.core.spans.Span} instances, with standard retry
  ...
  /**
   * Send a batch of {@link com.newrelic.telemetry.core.events.Event} instances, with standard retry
   * logic. This happens on a background thread, asynchronously, so currently there will be no
   * feedback to the caller outside of the logs.
   *
   * @param batch to be sent
  ...
  /**
   * Send a batch of {@link com.newrelic.telemetry.core.logs.Log} entries, with standard retry
   * logic. This happens on a background thread, asynchronously, so currently there will be no
   * feedback to the caller outside of the logs.
   *
   * @param batch to be sent
